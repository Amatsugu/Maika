...
-- Retrieve user.user_id, room.room_id, room.title, room.is_public --
SELECT u.user_id, r.room_id, r.title, r.is_public
FROM project.user u
...
-- Insert Room --
INSERT INTO project.room (owner_id, title, type) VALUES ('c492f646-d54d-11e7-9296-cec278b6b50a', 'test title', 'false');
...
SELECT DISTINCT r.title, r.type
FROM project.room r
